<?php
    ...
    if(isset($_POST['edit_student']))
    {
        ...
        $sql = "UPDATE students SET fname = '$fname', lname = '$lname', gender = '$gender', year = '$year', course = '$course', semester = '$semester'
        WHERE id =  $id";
...
<body>
    ...
    <form action="edit-students.php" method="post">
        ...
        <label for="">
            ...
            <input type="text" name="fname" value="<?= $_GET['fname']?>" required>
        </label><br>
        <label for="">
            ENTER LAST NAME:
            <input type="text" name="lname" value="<?= $_GET['lname']?>" required>
        </label><br>
        <div>
