...
<?php include_once "menu.php"; ?>
    <div>
    STUDENT: <?= $_GET['fname'] . " " . $_GET['lname']?> <br> <br>
    ...
    AVAILABLE SUBJECTS: 
    <br><br>
    <form action="subjects/add-student-subjects.php" method="post" >
    <table border="1">
    <thead>
    <tr>
    <th>#</th>
    ...
    <?php
        ...
        $sql = "SELECT * FROM subjects WHERE year = '$year' && course = '$course' && semester = '$semester' AND id NOT IN (SELECT subject_id FROM student_subjects WHERE student_id = '$id')";
        $result = $conn->query($sql);
